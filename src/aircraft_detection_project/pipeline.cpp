...
void analyzeImg(const std::string& testing_img_id)
{
    ...
    saveResults(testing_img_id, rois_label_pairs_all_points, src_img_gray);

    std::filesystem::path output_dir = std::filesystem::path(SRC_DIR_PATH) / "classification";
