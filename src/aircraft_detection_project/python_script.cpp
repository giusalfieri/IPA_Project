...
# Leggi il nome del file di ground truth dalla prima riga del file nella cartella classification
img_id_file_path = os.path.join(SRC_DIR_PATH, 'classification', 'testing_img_id.txt')
...
csv_file_path = os.path.join(SRC_DIR_PATH, 'classification', 'roi_label_pairs.csv')
roi_label_pairs = pd.read_csv(csv_file_path, header=None, names=['x1', 'y1', 'x2', 'y2', 'label'])

# Carica il file true_positive.sco
sco_file_path = os.path.join(SRC_DIR_PATH, 'classification', 'true_positive.sco')
true_positive_sco = pd.read_csv(sco_file_path, sep=r'\s+', header=None, skiprows=1, names=['index', 'score'])
output_csv_path = os.path.join(SRC_DIR_PATH, 'classification', 'true_positive_sco.csv')
...
# Salva il risultato in un nuovo file
output_file_path = os.path.join(SRC_DIR_PATH, 'classification', 'associated_labels_scores.csv')
